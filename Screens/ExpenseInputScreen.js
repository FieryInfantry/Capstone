  ...
  return (
    ...
    >
      <View style={ExpenseStyle.inputContainer}>
        ...
        {/* Modals for Account and Category */}
        <View style={ExpenseStyle.modalButtonsContainer}>
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Icon name="tags" size={20} color={isDarkMode ? '#FFF' : '#fff'} />
              <Text style={[ExpenseStyle.buttonText, { color: isDarkMode ? '#FFF' : '#fff' }]}>
                Category
              </Text>
            </View>
      ...
      <Modal
        ...
        animationType="slide"
      >
        <AccountModal closeModal={() => setAccountModalVisible(false)} />
      </Modal>
      ...
      <Modal
        ...
        animationType="slide"
      >
        <CategoryModal closeModal={() => setCategoryModalVisible(false)} />
      </Modal>
    </View>
  );
};
