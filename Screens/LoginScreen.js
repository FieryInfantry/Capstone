...
const LoginScreen = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme === 'dark' ? '#1A1A19' : '#F6FCDF' }}>
      <Text style={{ fontSize: 24, color: theme === 'dark' ? '#fff' : '#000', textAlign: 'center', marginTop: 50 }}>LOGO</Text>
      <Text style={{ fontSize: 18, color: theme === 'dark' ? '#fff' : '#000', textAlign: 'center' }}>Welcome to</Text>
